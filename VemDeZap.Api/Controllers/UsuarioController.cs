...
using VemDeZap.Domain.Commands.Usuario.AutenticarUsuarioRequest;
...
namespace VemDeZap.Api.Controllers
{
    public class UsuarioController : Base.ControllerBase
    {
        ...
        public async Task<IActionResult> Autenticar(
            ...
            [FromServices]SigningConfigurations signinConfigurations,
            [FromServices]TokenConfigurations tokenConfigurations)
        {
            try
            {
                ...
                {
                    var response = GerarToken(autenticarUsuarioResponse, signinConfigurations, tokenConfigurations);
                    return Ok(response);
                }
